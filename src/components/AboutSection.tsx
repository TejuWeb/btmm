      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {pillars.map((pillar, i) => (
              ...
              >
                ...
                <h4 className="font-bold text-lg mb-2 text-primary-navy dark:text-white">{pillar.title}</h4>
                <p className="text-sm text-foreground/60">{pillar.desc}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <div className="aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl relative group bg-primary-navy">
             ...
             <div className="absolute inset-0 bg-gradient-to-t from-primary-navy via-primary-navy/20 to-transparent flex items-end p-12">
                <div className="text-left">
                  ...
                  <p className="text-white text-2xl font-bold leading-relaxed mb-4">संघटन हीच शक्ती आहे, आणि सेवा हाच आमचा धर्म आहे.</p>
                </div>
             </div>
          ...
          <div className="absolute -bottom-10 -left-10 p-8 glass rounded-[2.5rem] shadow-2xl max-w-[240px] hidden md:block">
             <div className="text-4xl font-bold text-accent-blue mb-1">8+</div>
             <p className="text-sm font-semibold text-primary-navy opacity-80 uppercase tracking-widest">यशाची वर्षे</p>
